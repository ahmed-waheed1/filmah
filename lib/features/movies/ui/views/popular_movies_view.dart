...
class PopularMoviesView extends ConsumerStatefulWidget {
  static const String routeName = '/popularMovies';
  const PopularMoviesView({super.key});

  @override
  ConsumerState<PopularMoviesView> createState() => _PopularMoviesViewState();
}

class _PopularMoviesViewState extends ConsumerState<PopularMoviesView> {
  @override
  void initState() {
    super.initState();
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ref.read(moviesProvider.notifier).getPopularMovies();
    });
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: _buildBody(popularMovies, popularState),
    );
  }
  ...
  Widget _buildMoviesList(List<MovieEntity> movies) {
    return RefreshIndicator(
      onRefresh: () => ref.read(moviesProvider.notifier).getPopularMovies(),
